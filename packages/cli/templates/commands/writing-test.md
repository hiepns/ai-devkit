...
Review tests using the latest matching `{{docsDir}}/testing/YYYY-MM-DD-feature-{name}.md`. If none exists, use `{{docsDir}}/testing/feature-{name}.md`. Keep it aligned with the base template.
